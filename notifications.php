...
<body>
    <div class="profile_container">
        ...
        <div class="inner_profile">
            <div class="img">
                <img src="includes/classes/<?php echo $user_data->user_image; ?>" alt="Profile image">
            </div>
        ...
        <nav>
            <ul>
                ...
                <li><a href="edit-profile.php" rel="noopener noreferrer">Edit profile</a></li>
                ...
                if($get_req_num > 0){
                    foreach($get_all_req_sender as $row){
                        echo '<div class="user_box">
                                <div class="user_img"><img src="includes/classes/'.$row->user_image.'" alt="Profile image"></div>
